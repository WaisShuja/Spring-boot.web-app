...
<section id="search" class="section">
    ...
    <div class="container">
        ...
        <form:form action="/search" modelAttribute="search" method="get">
            ...
            <form:input type="search" path="search">
...
<footer class="footer">
    <div class="container">
        ...
        <p class="legal">Trust Sport is a fictitious brand created by lynda.com solely for the purpose of training. All products and people associated with H+ Sport are also fictitious. Any resemblance to real brands, products, or people is purely coincidental. Information provided about the product is also fictitious and should not be construed to be representative of actual products on the market in a similar product category.</p>
    </div><!-- container -->
</footer><!-- footer -->
